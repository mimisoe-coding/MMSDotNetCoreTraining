...
namespace MMSDotNetCore.MinimalAPI.Features.Painting
{
    public static class PaintingApi
    {
        public static IEndpointRouteBuilder MapPainting(this IEndpointRouteBuilder app)
        {
            #region Painting
